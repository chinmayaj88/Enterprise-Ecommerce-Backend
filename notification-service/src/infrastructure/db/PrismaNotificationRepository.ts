...
import { INotificationRepository, CreateNotificationData, NotificationFilterOptions } from '../../domain/repositories/INotificationRepository';
...
export class PrismaNotificationRepository implements INotificationRepository {
  ...
  async findByUserId(userId: string, options?: NotificationFilterOptions): Promise<Notification[]> {
    ...
    return notifications.map((n: any) => Notification.fromPrisma(n));
  }
