...
import { IOrderNoteRepository } from '../domain/repositories/IOrderNoteRepository';
import { ICartServiceClient } from '../infrastructure/clients/ICartServiceClient';
import { IProductServiceClient } from '../infrastructure/clients/IProductServiceClient';
import { IUserServiceClient } from '../infrastructure/clients/IUserServiceClient';
import { PrismaOrderRepository } from '../infrastructure/db/PrismaOrderRepository';
import { PrismaOrderItemRepository } from '../infrastructure/db/PrismaOrderItemRepository';
import { PrismaOrderShippingAddressRepository } from '../infrastructure/db/PrismaOrderShippingAddressRepository';
import { PrismaOrderStatusHistoryRepository } from '../infrastructure/db/PrismaOrderStatusHistoryRepository';
import { PrismaOrderNoteRepository } from '../infrastructure/db/PrismaOrderNoteRepository';
...
} from '../application/use-cases/OrderNoteUseCases';
import { OrderController } from '../application/use-cases/OrderController';
import { createEventPublisher } from '../infrastructure/messaging/EventPublisherFactory';
...
export class Container {
  ...
  private constructor() {
    ...
    // Configure via DATABASE_URL: postgresql://user:pass@host:5432/db?connection_limit=10&pool_timeout=20
