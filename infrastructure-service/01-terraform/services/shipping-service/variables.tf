# ============================================================================
# SHIPPING-SERVICE VARIABLES - Production Grade
# ============================================================================
# Service-specific variables for shipping-service
# ============================================================================
...
variable "service_replicas" {
  description = "Number of shipping-service replicas"
  type        = number
  default     = 2
  validation {
...
variable "database_url" {
  description = "Database connection URL for shipping-service (will be stored in vault)"
  type        = string
  sensitive   = true
}

variable "redis_url" {
  description = "Redis connection URL for shipping-service (will be stored in vault)"
  type        = string
  sensitive   = true
}
...
variable "order_service_url" {
  description = "Order service URL for order information"
  type        = string
