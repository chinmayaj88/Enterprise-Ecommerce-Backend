# ============================================================================
# RETURN-SERVICE VARIABLES - Production Grade
# ============================================================================
# Service-specific variables for return-service
# ============================================================================
...
variable "service_replicas" {
  description = "Number of return-service replicas"
  type        = number
  default     = 2
  validation {
...
variable "database_url" {
  description = "Database connection URL for return-service (will be stored in vault)"
  type        = string
  sensitive   = true
}

variable "redis_url" {
  description = "Redis connection URL for return-service (will be stored in vault)"
  type        = string
  sensitive   = true
}
...
variable "order_service_url" {
  description = "Order service URL for order validation"
  type        = string
  default     = "http://order-service:3007"
}

variable "payment_service_url" {
  description = "Payment service URL for refund processing"
  type        = string
  default     = "http://payment-service:3006"
}
