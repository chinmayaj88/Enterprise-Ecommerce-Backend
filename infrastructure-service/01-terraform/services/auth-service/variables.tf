# ============================================================================
# AUTH-SERVICE VARIABLES - Production Grade
# ============================================================================
# Service-specific variables for auth-service
# ============================================================================
...
variable "jwt_secret" {
  description = "JWT secret for auth-service (will be stored in vault)"
  type        = string
  sensitive   = true
...
variable "jwt_refresh_secret" {
  description = "JWT refresh secret for auth-service (will be stored in vault)"
  type        = string
  sensitive   = true
  # Generate with: openssl rand -base64 32
}
...
variable "database_url" {
  description = "Database connection URL for auth-service (will be stored in vault)"
  type        = string
  sensitive   = true
}

variable "cookie_secret" {
  description = "Cookie secret for auth-service (will be stored in vault)"
  type        = string
  sensitive   = true
  # Generate with: openssl rand -base64 32
}
