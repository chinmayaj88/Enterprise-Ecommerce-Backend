# ============================================================================
# DISCOUNT-SERVICE VARIABLES - Production Grade
# ============================================================================
# Service-specific variables for discount-service
# ============================================================================
...
variable "service_replicas" {
  description = "Number of discount-service replicas"
  type        = number
  default     = 2
  validation {
...
variable "database_url" {
  description = "Database connection URL for discount-service (will be stored in vault)"
  type        = string
  sensitive   = true
}

variable "redis_url" {
  description = "Redis connection URL for discount-service (will be stored in vault)"
  type        = string
  sensitive   = true
}
