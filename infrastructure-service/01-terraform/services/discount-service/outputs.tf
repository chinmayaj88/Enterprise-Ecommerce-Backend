# ============================================================================
# DISCOUNT-SERVICE OUTPUTS - Production Grade
# ============================================================================

output "namespace" {
  description = "Kubernetes namespace for discount-service"
  value       = kubernetes_namespace.discount.metadata[0].name
}

output "vault_id" {
  description = "Vault ID for discount-service secrets (shared vault from foundation)"
  value       = var.vault_id
}
...
output "dynamic_group_id" {
  description = "Dynamic group ID for discount-service"
  value       = oci_identity_dynamic_group.discount_service.id
}

output "next_steps" {
  description = "Instructions for deploying discount-service"
  value = <<-EOT
    ✅ Discount-service infrastructure created!
    ...
    3. Deploy discount-service using Kubernetes manifests:
