# ============================================================================
# PRODUCT-SERVICE VARIABLES - Production Grade
# ============================================================================
# Service-specific variables for product-service
# ============================================================================
...
variable "service_replicas" {
  description = "Number of product-service replicas"
  type        = number
  default     = 2
  validation {
...
variable "database_url" {
  description = "Database connection URL for product-service (will be stored in vault)"
  type        = string
  sensitive   = true
}
