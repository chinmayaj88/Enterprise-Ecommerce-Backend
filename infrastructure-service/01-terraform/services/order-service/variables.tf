# ============================================================================
# ORDER-SERVICE VARIABLES - Production Grade
# ============================================================================
# Service-specific variables for order-service
# ============================================================================
...
variable "database_url" {
  description = "Database connection URL for order-service (will be stored in vault)"
  type        = string
  sensitive   = true
}

variable "redis_url" {
  description = "Redis connection URL for order-service (will be stored in vault)"
  type        = string
  sensitive   = true
}

variable "cart_service_url" {
  description = "Cart service URL for order-service"
  type        = string
  default     = "http://cart-service:3004"
}

variable "product_service_url" {
  description = "Product service URL for order-service"
  type        = string
  default     = "http://product-service:3003"
}

variable "user_service_url" {
  description = "User service URL for order-service"
  type        = string
