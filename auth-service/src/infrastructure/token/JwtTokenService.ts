...
import { AuthTokenPayload, AuthTokens } from '../../domain/entities/AuthToken';
...
export class JwtTokenService implements ITokenService {
  ...
  constructor() {
    ...
    this.refreshSecret = config.jwt.refreshSecret || config.jwt.secret;
    this.accessExpiresIn = config.jwt.accessTokenExpiresIn || '15m';
    this.refreshExpiresIn = config.jwt.refreshTokenExpiresIn || '7d';
  }
