...
import { User, UserWithRoles, CreateUserData } from '../../domain/entities/User';
...
export class PrismaUserRepository implements IUserRepository {
  ...
  private getCacheTTL() {
    return {
      USER_BY_ID: this.CACHE_TTL,
      USER_BY_EMAIL: this.CACHE_TTL,
      USER_WITH_ROLES: Math.floor(this.CACHE_TTL * 0.67),
    };
  }
