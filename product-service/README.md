...
Product catalog management microservice built with **Clean Architecture** principles. This service handles product management, categories, variants, inventory, reviews, questions, and search functionality.
...
docker-compose exec product-service npm run prisma:migrate:deploy
...
- **OpenAPI Spec**: `http://localhost:3003/api-docs/openapi.yaml`
...
- `POST /api/v1/products/:productId/images` - Add image
- `GET /api/v1/products/:productId/images` - List images
- `PUT /api/v1/products/:productId/images/:id` - Update image
- `DELETE /api/v1/products/:productId/images/:id` - Delete image
- `POST /api/v1/products/:productId/images/:id/primary` - Set primary image

#### Product Review Endpoints
- `POST /api/v1/products/:productId/reviews` - Create review
- `GET /api/v1/products/:productId/reviews` - Get reviews
- `POST /api/v1/products/reviews/:id/helpful` - Mark review as helpful
- `PUT /api/v1/products/reviews/:id/moderate` - Moderate review

#### Product Question Endpoints
- `POST /api/v1/products/:productId/questions` - Create question
- `GET /api/v1/products/:productId/questions` - Get questions
- `POST /api/v1/products/questions/:id/answer` - Answer question
- `POST /api/v1/products/questions/:id/upvote` - Upvote question

#### Inventory Endpoints
- `POST /api/v1/products/:productId/inventory` - Create inventory record
- `GET /api/v1/products/:productId/inventory` - Get inventory
- `POST /api/v1/products/:productId/inventory/reserve` - Reserve inventory
- `POST /api/v1/products/:productId/inventory/release` - Release inventory
- `POST /api/v1/products/:productId/inventory/adjust` - Adjust inventory
...
See `config/default.json` and `config/development.json` for all available configuration options.
