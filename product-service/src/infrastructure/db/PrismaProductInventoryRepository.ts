...
import { IProductInventoryRepository, CreateProductInventoryData, UpdateProductInventoryData } from '../../domain/repositories/IProductInventoryRepository';
...
export class PrismaProductInventoryRepository implements IProductInventoryRepository {
  ...
  async create(data: CreateProductInventoryData): Promise<ProductInventory> {
    ...
    return ProductInventory.fromPrisma(inventory);
  }
