...
import { ICategoryRepository, CreateCategoryData, UpdateCategoryData } from '../../domain/repositories/ICategoryRepository';
...
export class PrismaCategoryRepository implements ICategoryRepository {
  ...
  async create(data: CreateCategoryData): Promise<Category> {
    ...
    const entity = Category.fromPrisma(category);
  ...
  async findAll(filters?: {
    ...
    return categories.map((cat: any) => Category.fromPrisma(cat));
  }
  ...
  async findChildren(parentId: string): Promise<Category[]> {
    ...
    const entities = categories.map((cat: any) => Category.fromPrisma(cat));
