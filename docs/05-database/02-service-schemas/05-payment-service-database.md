...
[![Payment Service](https://img.shields.io/badge/Service-Payment-orange?style=flat-square)](.)

**Payment processing, transactions, refunds, payment methods**
...
erDiagram
    ...
    PAYMENT_TRANSACTIONS {
        ...
        string providerTransactionId "Nullable"
        decimal amount
        string currency
        json providerResponse "Nullable"
        datetime processedAt "Nullable"
        datetime createdAt "Indexed"
    }
    ...
    PAYMENT_WEBHOOKS {
        string id PK "cuid()"
        string paymentId FK "Nullable, references payments.id"
        string provider "STRIPE|PAYPAL|MOCK"
        string eventType "payment.succeeded, etc."
        string providerEventId UK "Provider event ID, indexed"
    ...
    IDEMPOTENCY_KEYS {
        string id PK "cuid()"
        string key UK "Unique key, indexed"
    ...
    AUDIT_LOGS {
        ...
        string paymentId "Nullable, indexed"
        string orderId "Nullable, indexed"
