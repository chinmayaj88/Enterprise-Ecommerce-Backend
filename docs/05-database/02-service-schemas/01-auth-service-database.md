...
[![Auth](https://img.shields.io/badge/Service-Auth-orange?style=flat-square)](.)

**Authentication, authorization, and security management database**
...
erDiagram
    ...
    DEVICES ||--o{ LOGIN_HISTORY : "from"
    DEVICES ||--o{ USER_SESSIONS : "uses"
    REFRESH_TOKENS ||--o{ USER_SESSIONS : "linked_to"
    ...
    USERS {
        ...
        boolean mfaEnabled "Default: false, indexed"
        string mfaSecret "Nullable, encrypted TOTP secret"
        string[] mfaBackupCodes "Encrypted backup codes"
        datetime createdAt
        datetime updatedAt
    }
    ...
    USER_ROLES {
        ...
        string roleId FK "References roles.id, indexed"
        datetime createdAt
    ...
    REFRESH_TOKENS {
        ...
        string userId FK "References users.id, indexed"
        string deviceId FK "Nullable, references devices.id"
    ...
    DEVICES {
        string id PK "cuid()"
        string userId FK "References users.id, indexed"
        string deviceId UK "Unique device fingerprint"
        string deviceName "Nullable"
        string deviceType "mobile|tablet|desktop|unknown"
        string os "Nullable"
        ...
        boolean isTrusted "Default: false"
        datetime lastUsedAt "Indexed"
    ...
    LOGIN_HISTORY {
        ...
        string city "Nullable"
        string isp "Nullable"
        string status "success|failed|blocked, indexed"
        string failureReason "Nullable"
        boolean isSuspicious "Default: false, indexed"
        string suspiciousReason "Nullable"
        datetime createdAt "Indexed"
    }
    ...
    USER_SESSIONS {
        string id PK "cuid()"
        string userId FK "References users.id, indexed"
        string sessionToken UK "JWT access token ID"
        string refreshTokenId FK "Nullable, references refresh_tokens.id"
        string deviceId FK "Nullable, references devices.id"
        string ipAddress "Nullable"
        string userAgent "Nullable"
        string country "Nullable"
    ...
    MFA_BACKUP_CODES {
        ...
        string code "Hashed backup code, indexed"
        boolean used "Default: false"
        datetime usedAt "Nullable"
        datetime createdAt
        datetime expiresAt "Indexed"
