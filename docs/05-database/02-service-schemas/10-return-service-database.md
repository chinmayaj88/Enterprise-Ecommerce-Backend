...
# ↩️ Return Service Database Design
...
[![Return Service](https://img.shields.io/badge/Service-Return-orange?style=flat-square)](.)

**Return requests, return authorization (RMA), return tracking, refund coordination**
...
| Property | Value |
|:---:|:---|
| **🗄️ Database Name** | `return_db` |
| **↩️ Service** | Return Service |
