...
[![Notification Service](https://img.shields.io/badge/Service-Notification-orange?style=flat-square)](.)

**Notification management, email templates, notification preferences**
...
| Property | Value |
|:---:|:---|
| **🗄️ Database Name** | `notification_db` |
