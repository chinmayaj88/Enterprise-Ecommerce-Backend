...
[![Product Service](https://img.shields.io/badge/Service-Product-orange?style=flat-square)](.)

**Product catalog, categories, inventory, variants, reviews**
...
erDiagram
    ...
    PRODUCTS ||--o{ RECENTLY_VIEWED_PRODUCTS : "has"
    PRODUCTS ||--o{ PRICE_HISTORY : "has"
    PRODUCTS ||--o{ PRODUCT_SEARCH_HISTORY : "has"
    CATEGORIES ||--o{ PRODUCT_CATEGORIES : "contains"
    CATEGORIES ||--o{ CATEGORIES : "parent_category"
    PRODUCT_VARIANTS ||--o{ PRODUCT_INVENTORY : "tracks"
    ...
    PRODUCTS {
        ...
        text shortDescription "Nullable"
        ...
        int stockQuantity "Denormalized, default: 0"
        ...
        string metaTitle "Nullable, SEO"
        text metaDescription "Nullable, SEO"
        json attributes "Nullable"
        string[] badges "new, sale, featured, etc."
        int viewCount "Default: 0"
        int purchaseCount "Default: 0"
        int searchCount "Default: 0"
        datetime createdAt
        datetime updatedAt
    ...
    CATEGORIES {
        ...
        int level "Category depth, default: 0"
    ...
    PRODUCT_CATEGORIES {
        ...
        string categoryId FK "References categories.id, indexed"
        datetime createdAt
    ...
    PRODUCT_VARIANTS {
        ...
        string stockStatus "Default: out_of_stock"
        json attributes "Nullable, size, color, etc."
        string imageUrl "Nullable"
        datetime createdAt
        datetime updatedAt
    }
    ...
    PRODUCT_INVENTORY {
        ...
        string variantId FK "Nullable, references product_variants.id"
        int quantity "Default: 0"
        int reservedQuantity "Default: 0"
        int availableQuantity "Computed: quantity - reservedQuantity"
        string location "Nullable, warehouse_id"
        datetime lastRestockedAt "Nullable"
        datetime createdAt
        datetime updatedAt
        unique productId_variantId "Composite unique"
    }
    ...
    PRODUCT_QUESTIONS {
        string id PK "cuid()"
        string productId FK "References products.id, indexed"
        string userId "Nullable, references auth.users.id, indexed"
        text question
        text answer "Nullable"
        string answeredBy "Nullable, user ID"
        datetime answeredAt "Nullable"
        int upvotes "Default: 0"
        boolean isApproved "Default: false, indexed"
        int reportedCount "Default: 0"
        datetime createdAt "Indexed"
        datetime updatedAt
    }
    ...
    STOCK_ALERTS {
        ...
        unique userId_productId_variantId "Composite unique"
    }
    ...
    PRODUCT_COMPARISONS {
        ...
        string userId "Indexed"
        string name "Nullable"
        string[] productIds "Array of product IDs (max 4)"
        datetime createdAt "Indexed"
        datetime updatedAt
    }
    ...
    PRICE_HISTORY {
        ...
        decimal price
        decimal compareAtPrice "Nullable"
        string changedBy "Nullable, user ID or system"
    ...
    PRODUCT_SEARCH_HISTORY {
        string id PK "cuid()"
        string productId FK "Nullable, references products.id"
        string userId "Nullable, indexed"
        string query "Indexed"
        json filters "Nullable"
        int resultsCount "Nullable"
        datetime createdAt "Indexed"
    }
```
...
- View [Cross-Service References](../03-cross-service-references.md)
