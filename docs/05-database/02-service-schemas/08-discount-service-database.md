...
# 🎟️ Discount Service Database Design
...
[![Discount Service](https://img.shields.io/badge/Service-Discount-orange?style=flat-square)](.)

**Coupon codes, promotional campaigns, discount rules, usage tracking**
...
| Property | Value |
|:---:|:---|
| **🗄️ Database Name** | `discount_db` |
| **🎟️ Service** | Discount Service |
...
- View [Shipping Service Database](./09-shipping-service-database.md)
