...
[![Cart Service](https://img.shields.io/badge/Service-Cart-orange?style=flat-square)](.)

**Shopping cart management, cart items, cart persistence**
...
- View [Discount Service Database](./08-discount-service-database.md)
