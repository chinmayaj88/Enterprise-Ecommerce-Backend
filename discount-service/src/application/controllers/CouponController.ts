...
export class CouponController {
  ...
  async createCoupon(req: RequestWithId, res: Response): Promise<void> {
    try {
      ...
      sendCreated(res, 'Coupon created successfully', coupon, req.id);
    } catch (error: unknown) {
  ...
  async getCoupons(req: RequestWithId, res: Response): Promise<void> {
    try {
      ...
      sendSuccess(res, 'Coupons retrieved successfully', coupons, 200, req.id);
    } catch (error: unknown) {
      if (error instanceof AppError) {
        throw error;
      }
  ...
  async getCoupon(req: RequestWithId, res: Response): Promise<void> {
    try {
      ...
      sendSuccess(res, 'Coupon retrieved successfully', coupon, 200, req.id);
    } catch (error: unknown) {
      if (error instanceof AppError) {
        throw error;
      }
  ...
  async updateCoupon(req: RequestWithId, res: Response): Promise<void> {
    try {
      ...
      sendSuccess(res, 'Coupon updated successfully', updatedCoupon, 200, req.id);
    } catch (error: unknown) {
      if (error instanceof AppError) {
        throw error;
      }
  ...
  async deleteCoupon(req: RequestWithId, res: Response): Promise<void> {
    try {
      ...
      sendSuccess(res, 'Coupon deleted successfully', null, 200, req.id);
    } catch (error: unknown) {
      if (error instanceof AppError) {
        throw error;
      }
  ...
  async activateCoupon(req: RequestWithId, res: Response): Promise<void> {
    try {
      ...
      sendSuccess(res, 'Coupon activated successfully', activatedCoupon, 200, req.id);
    } catch (error: unknown) {
      if (error instanceof AppError) {
        throw error;
      }
  ...
  async deactivateCoupon(req: RequestWithId, res: Response): Promise<void> {
    try {
      ...
      sendSuccess(res, 'Coupon deactivated successfully', deactivatedCoupon, 200, req.id);
    } catch (error: unknown) {
      if (error instanceof AppError) {
        throw error;
      }
