...
export const serviceHealthChecker = new ServiceHealthChecker(30000); // Check every 30 seconds

// Get response cache instance
const responseCache = getResponseCache();

// Helper to create proxy middleware with circuit breaker
function createServiceProxy(
  ...
  const proxyMiddleware = createProxyMiddleware({
    ...
    changeOrigin: true,
    pathRewrite,
    timeout: config.server.proxyTimeout || 25000,
...
export function createProxyRoutes(): Router {
  ...
  router.use(
    '/api/v1/auth',
    conditionalAuth,
    createServiceProxy('auth-service', services.authServiceUrl || 'http://localhost:3001', {
  ...
  router.use(
    '/api/v1/users',
    authenticate,
    createServiceProxy('user-service', services.userServiceUrl || 'http://localhost:3002', {
  ...
  router.use(
    '/api/v1/products',
    conditionalAuth,
    createServiceProxy('product-service', services.productServiceUrl || 'http://localhost:3003', {
  ...
  router.use(
    '/api/v1/carts',
    conditionalAuth,
    createServiceProxy('cart-service', services.cartServiceUrl || 'http://localhost:3006', {
  ...
  router.use(
    '/api/v1/orders',
    authenticate,
    createServiceProxy('order-service', services.orderServiceUrl || 'http://localhost:3007', {
  ...
  router.use(
    '/api/v1/payments',
    conditionalAuth,
    createServiceProxy('payment-service', services.paymentServiceUrl || 'http://localhost:3006', {
  ...
  router.use(
    '/api/v1/coupons',
    conditionalAuth,
    createServiceProxy('discount-service', services.discountServiceUrl || 'http://localhost:3008', {
  ...
  router.use(
    ...
    authenticate,
    createServiceProxy('notification-service', services.notificationServiceUrl || 'http://localhost:3009', {
  ...
  router.use(
    '/api/v1/rates',
    conditionalAuth,
    createServiceProxy('shipping-service', services.shippingServiceUrl || 'http://localhost:3007', {
  ...
  router.use(
    '/api/v1/returns',
    authenticate,
    createServiceProxy('return-service', services.returnServiceUrl || 'http://localhost:3010', {
